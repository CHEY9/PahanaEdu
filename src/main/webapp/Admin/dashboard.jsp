...
<div class="container mt-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-sm-6 col-md-4">
            <a href="<%= request.getContextPath() %>/Admin/manage-items" class="btn btn-success w-100 py-3 fs-5">
                Manage Items
            </a>
        </div>
        <div class="col-sm-6 col-md-4">
            <a href="<%= request.getContextPath() %>/Admin/manage-bills" class="btn btn-secondary w-100 py-3 fs-5">
                View Bills
            </a>
        </div>
        <div class="col-sm-6 col-md-4">
            <a href="<%= request.getContextPath() %>/Admin/audit-logs" class="btn btn-dark w-100 py-3 fs-5">
                Audit Logs
            </a>
        </div>
        <div class="col-sm-6 col-md-4">
