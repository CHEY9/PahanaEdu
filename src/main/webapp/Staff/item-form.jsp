...
<div class="container mt-5">
    ...
    <form action="manage-items" method="post" novalidate>
        ...
        <div class="mb-3">
            ...
            <textarea
                    ...
                    rows="3"
                    required
            ><%= isEdit ? item.getDescription() : "" %></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <input
                    ...
                    id="stock"
                    class="form-control"
                    value="<%= isEdit ? item.getStockQuantity() : "" %>"
                    required
            />
        </div>
        ...
        <a href="manage-items" class="btn btn-secondary ms-2">Cancel</a>
    </form>
</div>
</body>
</html>
